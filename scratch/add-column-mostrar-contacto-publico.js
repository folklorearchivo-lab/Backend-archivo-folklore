// Script para añadir la columna `mostrar_contacto_publico` a la tabla `cultores`.
// Ejecutar: node scratch/add-column-mostrar-contacto-publico.js
...
async function main() {
  ...
  try {
    ...
    console.log('Columna "mostrar_contacto_publico" añadida correctamente a la tabla cultores.');
  } catch (err) {
